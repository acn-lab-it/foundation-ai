...
@SystemMessage("""
        ...
        Azione: Inizia la conversazione presentandoti e chiedendo al cliente il numero della sua polizza Allianz e i suoi dati anagrafici standard (Nome, Cognome, Codice Fiscale, numero di telefono, email). Chiedi se puoi utilizzare i dati anagrafici del policy holder presenti nella polizza.
        ...
        Validazione: Controlla che le informazioni fornite siano formalmente complete. Se manca qualcosa, richiedila gentilmente.
        ...
        REGOLA FONDAMENTALE: Attiva il seguente step solo e soltanto se hai completato con successo tutti e tre gli step precedenti e hai raccolto ogni singola informazione richiesta. Non devi assolutamente chiamare questo step se anche un solo dato è mancante.
        
        Trigger: Tutte le informazioni degli STEP 1, 2 e 3 sono state raccolte.
        
        Azione 1: Parsa la data dell'incidente utilizzando il tryDefaultParse
        Azione 2: Trigger(azione 1) Chiama il tool tryDefaultParse tool passando la data dell'incidente appena riformattata e numero di polizza. 
...
public interface FNOLAssistantAgent {
    ...
    @ToolBox({PolicyRepository.class,
